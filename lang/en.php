...
array_push($lang['vip_benefits'],['icon' => "image-text",
    'title' => "Supress #Log updates",
    'description' => "When we update a playlist, we append a #log of what was done, but if you're VIP you can silence this, making the update process entirely invisible."]);

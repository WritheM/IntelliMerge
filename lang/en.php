...
$lang['about']['q_a']['limits']['answer'] = "We currently limit <strong>the number of songs</strong> that will be added to a master list, as well as <strong>the number of master lists</strong> per account. To keep the number of hits to the Spotify API reasonable, we only add the first {$cfg['app']['playlist_limit_basic']} songs that are found on a scan. We first compile a list of songs we need to add, accounting for the songs that are excluded, and stop once we hit {$cfg['app']['playlist_limit_basic']} songs. Then we remove the old songs, which means that if we need to remove any, you'll have less than {$cfg['app']['playlist_limit_basic']} songs. Once the updater runs again, it should pick up some additional songs and get you closer to {$cfg['app']['playlist_limit_basic']} songs though. Additionally, we do increase this basic limit to {$cfg['app']['playlist_limit_vip']} songs for VIP Users. Additionally, users will only be able to make {$cfg['app']['playlist_count_basic']} Master Playlists per account. VIP Users are allowed to make {$cfg['app']['playlist_count_vip']} Master Playlists.";
